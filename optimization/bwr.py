"""
BWR (Best-Worst-Random) Algorithm implementation for solar module parameter optimization
"""
import numpy as np
...
class BWROptimizer(BaseOptimizer):
    """
    BWR (Best-Worst-Random) Algorithm - A nature-inspired optimization algorithm
    
    The algorithm uses the best, worst, and randomly selected solutions to guide
    ...
    def optimize(self) -> Tuple[np.ndarray, float]:
        """
        Run the BWR optimization algorithm
            ...
            for i in range(self.population_size):
                ...
                if r4 > 0.5:
                    ...
                    new_solution = (population[i] + 
                                  r1 * (best_solution - T * random_solution) -
                                  r2 * (worst_solution - random_solution))
                else:
                    # Random reinitialization (Eq. 4)
                    # R = Uj - (Uj - Lj) * r3
    ...
    def get_algorithm_info(self) -> Dict:
        ...
        return {
            ...
            'description': 'Uses best, worst, and random solutions for population update',
            'update_mechanism': 'Exploitation via best guidance, exploration via worst avoidance and randomization'
        }